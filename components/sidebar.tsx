...
import { BrushIcon, CodepenIcon, ImageIcon, LayoutDashboard, MessageSquare, Music, Settings, VideoIcon } from 'lucide-react';
...
const routes = [ 
  {  // array that holds all of our sidebar routes
    label:"Dashboard",
